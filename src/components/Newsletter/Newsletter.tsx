...
const Newsletter = () => {
  return (
    <div className='relative px-6'>
      <div className='mx-auto max-w-2xl bg-primary-500 br-50 md:max-w-7xl mt-0 md:mt-24 rounded-lg'>
                ...
                >
                  <div className='relative text-white focus-within:text-white flex flex-row-reverse shadow-fi rounded-full'>
                    <Input
                      type='Email address'
                      name='email'
                      className='py-6 sm:py-8 text-sm w-full text-black bg-white rounded-full pl-4 par-87 focus:outline-none focus:text-black'
